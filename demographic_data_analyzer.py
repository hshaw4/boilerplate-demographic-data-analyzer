...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = round(df[df['sex'] == 'Male']['age'].mean() , 1) #Uses a boolean to select the age columns where the sex is male
    ...
    rich_percentage = (num_min_workers[df['salary']=='>50K'].value_counts().sum()/num_min_workers.value_counts().sum()) * 100
